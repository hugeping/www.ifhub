...
{else}
	...
	<script>
		jQuery(function($){
			ls.lang.load({lang_load name="panel_b,panel_i,panel_s,panel_url,panel_url_promt,panel_image,panel_quote,panel_clear_tags,panel_image_promt,panel_user_promt,panel_spoiler_promt,panel_spoiler"});
			// Подключаем редактор
