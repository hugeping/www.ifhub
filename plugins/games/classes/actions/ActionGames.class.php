...
class PluginGames_ActionGames extends ActionPlugin
{
     ...
     * @var string
     */
    protected $sMenuSubItemSelect='games';
    /**
     * Текущий юзер
     *
...
/**
    ...
    protected function SubmitAdd() {
        ...
        $oTopic->_setValidateScenario('games');
        /**
        ...
        if ($this->Topic_AddTopic($oTopic)) {
            ...
            $this->Topic_UpdateTopicFieldsGames($oTopic);
            /**
    ...
    protected function checkTopicFields($oTopic) {
         ...
         * Выполнение хуков
         */
        $this->Hook_Run('check_games_fields', array('bOk'=>&$bOk));
